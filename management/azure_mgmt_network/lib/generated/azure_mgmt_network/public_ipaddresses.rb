...
module Azure::ARM::Network
  ...
  class PublicIPAddresses
    ...
    #
    def delete_with_http_info(resource_group_name, public_ip_address_name, custom_headers = nil)
      delete_async(resource_group_name, public_ip_address_name, custom_headers).value!
    end
    ...
    # @return [MsRest::HttpOperationResponse] HTTP response information.
    #
    def create_or_update_with_http_info(resource_group_name, public_ip_address_name, parameters, custom_headers = nil)
      create_or_update_async(resource_group_name, public_ip_address_name, parameters, custom_headers).value!
    end
    ...
    def create_or_update_async(resource_group_name, public_ip_address_name, parameters, custom_headers = nil)
      ...
      # Serialize Request
      request_mapper = Azure::ARM::Network::Models::PublicIPAddress.mapper()
    ...
    def list_all_async(custom_headers = nil)
      ...
      promise = promise.then do |result|
        ...
        if status_code == 200
          begin
            parsed_response = response_content.to_s.empty? ? nil : JSON.load(response_content)
            result_mapper = Azure::ARM::Network::Models::PublicIPAddressListResult.mapper()
            result.body = @client.deserialize(result_mapper, parsed_response)
          rescue Exception => e
            fail MsRest::DeserializationError.new('Error occurred in deserializing the response', e.message, e.backtrace, result)
          end
